...
\end{center}
\caption{Build time, run time per character and space for the Clifford et al.\@ algorithm (Green) against Aho-Corasick (Blue) over the length of the pattern. See Figure~\ref{fig:case-results} for a better view of the space consumption for Clifford et al.}
...
\end{center}
\caption{Build time, run time per character and space for the Clifford et al.\@ algorithm (Green) against Aho-Corasick (Blue) over the number of patterns. See Figure~\ref{fig:case-results} for a better view of the space consumption for Clifford et al.}
