...
\subsection{Sublinear Space Pattern Matching}

The focus of this project is pattern matching. Pattern matching is a broad range of problems covering the general question of ``Here is a text; here is a pattern; where does this pattern occur in this text?'' While this is merely one question of pattern matching, a number of other related problems also exist:
...
\begin{itemize}
  ...
  \item \textbf{Distance Matching:} ``How much does this text differ from this pattern at each index?''
\end{itemize}
...
\subsection{Why Dictionary Matching?}
...
Our overall goal for this project is to reduce the processing size for dictionary matching and improve the current streaming performance over that of Aho-Corasick. In order to achieve this, our concrete objectives are:
