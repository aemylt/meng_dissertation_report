...
\begin{itemize}
  \item The number of matches to see how much the algorithms disagreed
...
\end{center}
\caption{Build time for Clifford et al.'s algorithm against Aho-Corasick}
\label{fig:long-pattern-build}
\end{figure}
...
\end{center}
\caption{Run time per character and space for Clifford et al.'s algorithm against Aho-Corasick}
