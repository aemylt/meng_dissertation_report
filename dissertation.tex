...
\begin{itemize}
  ...
  \item I implemented the first ever version of the Clifford et al. \cite{2015arXiv150406242C} algorithm. As part of this, I found a number of issues with the version of the paper used for this implementation, and either fixed them or provided further analysis of them.
...
Furthermore, it might be possible to improve the algorithm. There is no currently known lower bound for the algorithm, so a constant time solution might be achievable. This is a very difficult task however, and would require a strong combination of both theory and applied work to produce both an algorithm and an implementation.
