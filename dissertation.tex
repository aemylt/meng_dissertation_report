...
As for comparative performance of preprocessing time, Clifford et al. takes roughly the same amount of time if not less than Aho-Corasick, as long as the majority of patterns are not short. If most patterns are short, then Clifford et al. can take dramatically longer time.
...
\subsection{More Thorough Comparison and Testing}

\subsection{Comparison with Breslauer and Galil}
